...
plotDimRed(seurat_data, col_by = "RNA_celltype_byrnes_d2",
           plot_type = "rna.umap")

table(seurat_data$RNA_celltype_byrnes, seurat_data$RNA_celltype_byrnes_d2)
...
plotDimRed(seurat_data, col_by = "RNA_baron_celltype_d2", plot_type = "rna.umap")

table(seurat_data$RNA_baron_celltype, seurat_data$RNA_baron_celltype_d2)
...
cluster_res <- clustifyr_orthologs(seurat_data, ref_mat,
                                   save_dir = save_dir,
                                   save_name = "tabula_muris_celltype_d2",
                                   mapping_file = mapping_file,
                                   mapping_gene_col = "gene_id",
                                   mapping_ortholog_col = "Mouse.gene.name",
                                   assay = "RNA",
...
plotDimRed(seurat_data, col_by = "RNA_tabula_muris_celltype_d2",
           plot_type = "rna.umap")

table(seurat_data$RNA_tabula_muris_celltype,
      seurat_data$RNA_tabula_muris_celltype_d2)
...
cluster_res <- clustifyr_orthologs(seurat_data, ref_mat,
                                   save_dir = save_dir,
                                   save_name = "baron_human_celltype_d2",
                                   mapping_file = mapping_file,
                                   mapping_gene_col = "gene_id",
...
plotDimRed(seurat_data, col_by = "RNA_baron_human_celltype_d2",
           plot_type = "rna.umap")


table(seurat_data$RNA_baron_human_celltype,
      seurat_data$RNA_baron_human_celltype_d2)
...
plotDimRed(seurat_data, col_by = "RNA_qadir_celltype_d2",
           plot_type = "rna.umap")

table(seurat_data$RNA_qadir_celltype, seurat_data$RNA_qadir_celltype_d2)
...
plotDimRed(seurat_data, col_by = "RNA_muraro_celltype_d2",
           plot_type = "rna.umap")

table(seurat_data$RNA_muraro_celltype, seurat_data$RNA_muraro_celltype_d2)
...
plotDimRed(seurat_data, col_by = "RNA_krentz_celltype_d2",
           plot_type = "rna.umap")

table(seurat_data$RNA_krentz_celltype, seurat_data$RNA_krentz_celltype_d2)
...
seurat_data$RNA_combined_celltype_d2 <- new_clusters[seurat_data$RNA_cluster]

plotDimRed(seurat_data, col_by = "RNA_combined_celltype",
           plot_type = "rna.umap")

plotDimRed(seurat_data, col_by = "RNA_combined_celltype_d2",
           plot_type = "rna.umap")


seurat_data$RNA_combined_celltype_d2 <- gsub("_h$", "",
                                          seurat_data$RNA_combined_celltype_d2)
seurat_data$RNA_combined_celltype_d2 <- gsub("_m$", "",
                                          seurat_data$RNA_combined_celltype_d2)
seurat_data$RNA_combined_celltype_d2 <- gsub("Acinar", "acinar",
                                          seurat_data$RNA_combined_celltype_d2)

seurat_data$RNA_combined_celltype_d2 <- gsub("Ductal", "ductal",
                                          seurat_data$RNA_combined_celltype_d2)


table(seurat_data$RNA_combined_celltype, seurat_data$RNA_combined_celltype_d2)
